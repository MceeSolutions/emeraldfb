...
class purchase_request(models.Model):
    ...
    request_line = fields.One2many(
        string='Request Line',
        comodel_name='material_request.material_request_line',
    ...
    def approve_request(self):
        self.number = self.env['ir.sequence'].next_by_code('material_request.material_request')
...
class PurchaseRequestLine(models.Model):
    _name = "material_request.material_request_line"
    ...
    request_id = fields.Many2one(comodel_name="material_request.material_request", string="Request")
